...
public:
  ...
  Image() : width_(0), height_(0), bytes_pp_(0), pitch_(0)
  {}

  Image(int wid, int hei, int bpp) : width_(wid), height_(hei), bytes_pp_(bpp)
  {
  ...
  bool scale_xy(int factor, Image & target_image) const;
